...
<main class="container">
    ...
    @endif
    <form action="{{ route('tambahdaop') }}" method="POST">
        @csrf
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
                <div class="mb-4 text-center">
                    <h1 class="text-2xl font-bold text-gray-800">Tambah Daop</h1>
                </div>
                <label for="namadaop" class="col-sm-2 col-form-label">Nama Daop</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="namadaop" id="namadaop" value="{{ Session::get('namadaop') }}">
