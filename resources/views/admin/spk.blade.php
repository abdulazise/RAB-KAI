...
@include('layout.partial.header')
    ...
    <!--Metric Card-->
    <div class="bg-white border rounded shadow p-2" onclick="window.location='{{ route('listrab') }}'">
        <div class="flex flex-row items-center">
            ...
            <div class="flex-1 text-right md:text-center">
                <h5 class="font-bold uppercase text-gray-500">Document Rab</h5>
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border rounded shadow p-2"  onclick="window.location='{{ route('listrab') }}'" >
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Document SPK</h5>
                                <h3 class="font-bold text-3xl">2</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Document HPS</h5>
                                <h3 class="font-bold text-3xl">2</h3>
                            </div>
                        </div>
                    </div>
