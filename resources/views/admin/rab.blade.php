    ...
    <div class="container w-full mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="flex flex-1  px-2 py-3 flex-col md:flex-row lg:flex-row mx-2">       
                        <div class="mb-2 border-gray-300 rounded border shadow-sm w-full" >
                                ...
                                <table class="table-responsive w-full rounded">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border px-4 py-2">
                                                <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-blue">
                                                        <i class="fas fa-eye"></i></a>
                                                <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-green">
                        ...
                        <a href="{{ route('tambah') }}" class="text-center">          
                        Tambah</a>
                                </button>
