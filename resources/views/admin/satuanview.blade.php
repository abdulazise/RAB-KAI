...
<div class="pb-3">
    <a href="{{ url('satuantambah') }}" class="btn btn-secondary" style="background-color: orange; border-color: orange; color: white;">Kembali</a>
</div>
...
<div class="pb-3">
    <form action="{{ url('satuanview') }}" method="get">
        ...
        <!-- TOMBOL TAMBAH DATA -->
        <div class="pb-3">
          <a href="{{ route('satuantambah') }}" class="btn btn-primary">+ Tambah Data</a>
        </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ url('satuantambah/' . $item->id. '/edit') }}" class="btn btn-warning btn-sm">Edit</a>
                <form action="{{ url('satuantambah/' . $item->id) }}" method="POST" class="d-inline">
                  @csrf
                  @method('DELETE')
