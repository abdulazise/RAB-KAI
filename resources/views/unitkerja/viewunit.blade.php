...
<html lang="en">
  <head>
    ...
    <title>Daftar Unit Kerja KAI</title>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <td>{{ $loop->iteration }}</td>
              ...
              <td>{{ $item->DAOP}}</td>
              <td>
              <a href="{{ url('tambahunit/' . $item->unit . '/editunit') }}" class="btn btn-warning btn-sm">Edit</a>
            <form action="{{ url('tambahunit/' . $item->unit . '/editunit') }}" method="POST" class="d-inline">
              @csrf
              @method('DELETE')
