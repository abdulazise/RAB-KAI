...
class CreateTabletmonitorCatalogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tabletmonitor_catalogs', function (Blueprint $table) {
            $table->id('id_tabletmonitor');
    ...
    {
        Schema::dropIfExists('tabletmonitor_catalogs');
    }
}
