...
class CreatePcLapAioMinipcCatalogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('PcLapAioMinipc_catalogs', function (Blueprint $table) {
            $table->id('id_PcLapAioMinipc');
    ...
    {
        Schema::dropIfExists('PcLapAioMinipc_catalogs');
    }
}
